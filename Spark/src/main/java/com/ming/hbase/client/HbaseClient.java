...
public class HbaseClient {
    ...
    static {
        ...
        conf.set("hbase.rootdir", "hbase.rootdir");
        conf.set("hbase.zookeeper.quorum", "hbase.zookeeper.quorum");
        conf.set("hbase.client.scanner.timeout.period", "hbase.client.scanner.timeout.period");
        conf.set("hbase.rpc.timeout", "hbase.rpc.timeout");
        try {
